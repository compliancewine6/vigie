...
- section_id (LE TYPE d'exigence) parmi exactement: ${SECTIONS.replace(/\n/g, ' ')}
- process_stage (QUAND/OÙ elle s'applique dans le process) parmi exactement: ${STAGES.replace(/\n/g, ' ')}
  Choisis le stade le plus pertinent ; si plusieurs s'appliquent, choisis celui où l'action concrète a lieu. Mets null
  seulement si vraiment aucun des 6 ne correspond.
